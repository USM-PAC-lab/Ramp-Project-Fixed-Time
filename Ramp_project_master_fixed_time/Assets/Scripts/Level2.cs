            ...
            if (Testend == false)
            {
                if (TestStart == true)
                {
                    ...
                    if (KeysEnabled == true)
                    {
                        ...
                        if (WaitTimer >= 5.0f)// allows the participant to make a decition after 2 seconds

                        {
                            ...
                            bool v = (OVRInput.GetDown(OVRInput.Button.One) || (OVRInput.GetDown(OVRInput.Button.Three)));
                            if ((WaitTimer >= 5.0f) & v)
                            {
