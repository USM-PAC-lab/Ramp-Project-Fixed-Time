            ...
            if (recording == true)
            {
                ...
                if (KeysEnabled == true)
                {
...

                    {
                        ...
                        if (OVRInput.GetDown(OVRInput.Button.One) & WaitTimer >= 5.0f)//Button (X) on the touch controller
                        ...
                        if (OVRInput.GetDown(OVRInput.Button.Three) & WaitTimer >= 5.0f)//Tells unity which button to listen for. In this case (A)
